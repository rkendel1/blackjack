<script lang="ts">
	import '../global.css';
	import { GoFishGame } from '$lib/games/go-fish/store';
	...
	<div class="container">
		...
		<div class="scores">
			...
			<div class="score-item">
				...
				<strong>{game.ai.score}</strong>
			</div>
			<div class="score-item">
				<span>Deck:</span>
				<strong>{game.deck.remaining}</strong>
			</div>
		</div>
		...
		<div class="game-area">
			...
			<div class="opponent-hand">
				<h3>Computer ({game.ai.hand.length} cards)</h3>
				<div class="cards-row">
					{#each game.ai.hand as _card, i}
			...
			<div class="player-hand">
				<h3>Your Hand ({game.player.hand.length} cards)</h3>
				<div class="cards-row">
					{#each game.player.hand as card}
						<button
							class="card-button"
							class:selectable={game.state === 'player-turn'}
							onclick={() => handleRankClick(card.rank)}
							disabled={game.state !== 'player-turn'}
						>
